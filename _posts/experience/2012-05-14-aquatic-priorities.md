...
<div class="pull-right thumbnail thumb-wrap">
	<a href="{{BASE_PATH}}{{page.image}}"><img class="span5" src="{{BASE_PATH}}/assets/img/experience/aquatic-priorities/ap_salmon_jump.jpg" alt=""/></a>
</div>
