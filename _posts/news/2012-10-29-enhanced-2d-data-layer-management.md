...
3. Include the interface elements via django _include_ template tags

For full instructions on configuring the layer manager, see [the docs](http://ecotrust.github.io/madrona/docs/layer_manager.html)
