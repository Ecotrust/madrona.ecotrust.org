...
- [Map bookmarks](http://ecotrust.github.io/madrona/docs/bookmarks.html)
- [GeoJSON support](http://ecotrust.github.io/madrona/docs/geojson.html") for the Madrona Feature API
