...
{% include JB/setup %}
One of the most requested features for any web mapping application is printing. <a target="_blank" href="http://ecotrust.github.io/madrona/docs/bookmarks.html">Map bookmarks</a> get you most of the way there for sharing your map view, but people want the digital equivalent of a hard copy.
